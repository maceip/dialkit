...
export function SettingsPanel({
  ...
  return (
    <div
      ...
      data-dialkit-annotation-settings-panel
    >
      <div className={styles.settingsPanelContainer}>
        ...
        >
          <div className={styles.settingsHeader}>
            <a className={styles.settingsBrand} href="https://github.com/maceip/dialkit" target="_blank" rel="noopener noreferrer">
            ...
            <p className={styles.settingsVersion}>v1.4.0 (local)</p>
            <button
          ...
          >
            <span>Integrations (disabled)</span>
